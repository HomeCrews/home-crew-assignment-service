# home-crew-assignment-service

Matches bookings to available workers.
...
|---|---|
| Port | 8089 |
| Route through the gateway | `/assignments/**` |
| Java package | `com.homecrew.assignmentservice` |
| Maven artifact | `assignmentservice` |
| Image | `mthanuj/homecrew-assignment-service:dev` |
| Compose service | `assignment-service` |
| Database | none yet - see home-crew-infrastructure |
| Default branch | `dev` |
...
A push to `dev` builds the image and pushes two tags to Docker Hub:
    ...
    mthanuj/homecrew-assignment-service:dev
    mthanuj/homecrew-assignment-service:sha-<short>
